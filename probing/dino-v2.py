...
parser.add_argument("--model_name", type=str, default='facebook/dinov2-base', help="Name of the model")
...
class ProbingModel(nn.Module):
    ...
    def forward(self, image1, image2):
        image1_features = self.model(image1).last_hidden_state[:, 0, :].float()  
        image2_features = self.model(image2).last_hidden_state[:, 0, :].float()
